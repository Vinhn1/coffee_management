<div class="container mt-4">
    ...
    <form action="index.php?controller=employee&action=create" method="POST" class="row g-3" id="addEmployee">
        <!-- ID -->
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <input type="number" class="form-control" id="sdt" name="sdt" require>
        </div>

        <!-- Chức Vụ -->
        <div class="col-md-6">
            <label for="chucvu" class="form-label">Chức vụ</label>
            <input type="text" class="form-control" id="chucvu" name="chucvu" require>
        </div>

        <!-- Lương cơ bản -->
        <div class="col-md-6">
            <label for="luongcoban" class="form-label">Lương cơ bản</label>
            <input type="number" class="form-control" id="luongcoban" name="luongcoban" require>
        </div>

        <!-- Ngày vào làm -->
        <div class="col-md-6">
            <label for="ngayvaolam" class="form-label">Ngày vào làm</label>
            <input type="date" class="form-control" id="ngayvaolam" name="ngayvaolam" require>
        </div>
